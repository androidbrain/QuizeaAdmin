...
public class AddQuestionActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        uploadQues=findViewById(R.id.uploadQuestion);
        ...
        uploadQues.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                if (question.getText().toString().isEmpty()){
                    Toast.makeText(AddQuestionActivity.this, "Add Question!", Toast.LENGTH_SHORT).show();
    ...
    private void upload(){
        ...
        if (correct==-1){
            Toast.makeText(this, "Select Correct Options!", Toast.LENGTH_SHORT).show();
            return;
        }
                ...
                .setValue(map).addOnCompleteListener(new OnCompleteListener<Void>() {
                    ...
                    public void onComplete(@NonNull Task<Void> task) {
                        if (task.isSuccessful()){
                            QuestionModel questionModel=new QuestionModel(map.get("question").toString(),id,
